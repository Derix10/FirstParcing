...
class PlayListDetailsAdapter : RecyclerView.Adapter<PlayListDetailsAdapter.PlaylistDetailsHolder>() {
    ...
    inner class PlaylistDetailsHolder(private var binding: PlaylistItemBinding): RecyclerView.ViewHolder(binding.root) {
